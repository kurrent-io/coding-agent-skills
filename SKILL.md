...
| Circuit breaker pattern | `samples/circuit-breaker/` |
| Correlation/causation IDs | `samples/correlation-causation/` |
| Left-fold projections (CQRS read models) | `samples/left-fold-projection/` |
...
See `samples/` directory for ready-to-run implementations:
- **Circuit breaker** - Resilient event processing (all 7 languages)
- **Correlation/causation** - Track event relationships
- **Left-fold projections** - Build in-memory read models (all 7 languages)
